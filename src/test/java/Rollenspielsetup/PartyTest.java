...
//        System.out.println(wizard2.getId());
        ...
        party4.importParty("partyOne.csv");
        party3.importParty("partyOne.csv");

        //Test Character 1
        //assertEquals (party4.getParty().get(0).getId(), party3.getParty().get(0).getId());
        assertEquals(party4.getParty(),party3.getParty());
...
//        assertTrue(party3.getParty().get(2) instanceof Wizard);
    ...
    void testimportexport() {
        ...
        party1.exportParty("partyOne.csv");
        party2.exportParty("partyTwo.csv");
        // assertEquals(inputString,party3.exportParty(inputString));
    }
